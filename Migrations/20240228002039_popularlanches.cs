...
namespace LanchesMac.Migrations
{
    public partial class popularlanches : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("INSERT INTO Lanches(CategoriaId,DescricaoCurta,DescricaoDetalhada,EmEstoque,ImagemThumbnailUrl,ImagemUrl,IsLanchePreferido,Nome,Preco) Values(3,'Bolo de chocolate simples', 'Bolo de chocolate com cobertura de glacê',1,'https://lanches.macoratti.net/images/produtos/bolo_chocolate1.jpg','https://lanches.macoratti.net/images/produtos/bolo_chocolate1.jpg', 0, 'Bolo de chocolate', '8.00')");
        }
